...
git pull
```
Эта команда необходима для получения изменений и слияния с локальной версией. 
...
Чтобы проводить изсененения в чужом репозитории на сужом аккаунте, нужно войти в репозиторий на гитхабе и нажать на иконку "Fork". Тогда этот чужой репозиторий скопируется на наш аккаунт на гитхабе. И тогда можно начинать работать с этим репозиторием. Его надо стянуть на локальный ПК командой "pull"