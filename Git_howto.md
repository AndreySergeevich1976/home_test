...
## № Создали ветку №2 log_oneline_graph, произведем описание новой команды гит, а потом выше уберем задваивание, не выходя из ветки log_oneline_graph, а потом войдем в мастер и там еще что нибудь поменяем, тогда дожен получится конфликт, который гид сам не исправит.

И так, эта команда выводит последовательность комитов с направлениями ветвления, как то так я понял.
```sh
